...
<div class="w3-sidebar w3-bar-block w3-card w3-animate-left" style="display:none" id="mySidebar">
  ...
  <a href="list_artikel.php" class="w3-bar-item w3-button">List Artikel</a>
      ...
      <div class="w3-col 40 s20">
        <div class="w3-card-4 w3-margin w3-light-grey">
          <div class="w3-container">
            <br>               
                <br>
                    <p>Nama : Yohanes Antonius</p> 
                <br>
                    <p>Nim  : 1714321010</p>
                <br>
                    <p>Kelas: D</p>
                <br>
                    <p>Job  : Junior Programmer di CV. Primavisi Globallindo, Gunung Anyar - Surabaya</p>
                <br>
            </div>
        </div>
    </div>
